...
var Saved = React.createClass({
	...
	clickHandler: function(event) {
		...
		// callback function so the state can update before we do anyting this that data
			...
			// call the deleteSave function and pass the article
			helpers.deleteSaved(this.state.article_delete);

			// this needs to be called in the callback or this function will run before deleteSave and the screen won't remove the most recently deleted article without refreshing or clicking on another article to delete
			...
			this.props.setDeleteSaved(this.state.article_delete);
